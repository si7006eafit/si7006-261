...
en lab debe ser ejecutable en minimo Google Colab y de segunda forma en AWS EMR con los notebooks de EMR o en Databricks; datos en google drive, AWS S3, Volumenes Databricks. El desarrollo lo puede hacer local con Anaconda3 o python y la libreria pyspark instalada. Tambien lo puede hacer con aws boto3 o google colab.