...
## "SPARK_HOME" = "/home/ec2-user/spark-4.1.1-bin-hadoop3"
    ...
    wget -q https://downloads.apache.org/spark/spark-4.1.1/spark-4.1.1-bin-hadoop3.tgz
    tar xf spark-4.1.1-bin-hadoop3.tgz
    export SPARK_HOME=/home/ec2-user/spark-4.1.1-bin-hadoop3
    ...
    git clone https://github.com/si7006eafit/si7006-261.git
    cd si7006eafit/si7006-261/streaming/spark-streaming/
